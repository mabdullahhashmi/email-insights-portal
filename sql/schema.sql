...
CREATE TABLE IF NOT EXISTS sent_messages (
    ...
    recipient_email_snapshot VARCHAR(190) NOT NULL,
    recipient_name_snapshot VARCHAR(190) DEFAULT '',
    subject VARCHAR(255) DEFAULT '',
    original_html LONGTEXT,
    tracked_html LONGTEXT,
    send_status VARCHAR(30) NOT NULL DEFAULT 'generated',
    ...
    KEY idx_send_status_scheduled (send_status, scheduled_at_utc),
    KEY idx_created_at (created_at),
